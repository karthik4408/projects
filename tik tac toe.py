...
def intro():
   # This function introduces the rules of the game Tic Tac Toe
    ...
    print("                                       Hello! Welcome to Group-06 Tic Tac Toe game!                        ")
    print("\n")
    print("                                       --------------Please Go Through the Rules---------------            ")
    print("\n")

    print("Rule 1: Player 1 and player 2, represented by X and O, take turns.\n")
    print("Rule 2: Marking the spaces in a 3*3 grid. The player who succeeds in placing.\n")
    print("Rule 3: Three of their marks in a horizontal, vertical, or diagonal row wins.\n")
    print("\n")
